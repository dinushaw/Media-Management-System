...
<table width="960" align="center" cellpadding="0" cellspacing="0" class="tableboarder">
  ...
  <tr class="tableboarder">
    ...
    <td width="830" style="padding:10px;"><!-- InstanceBeginEditable name="EditRegion1" -->
      <h4>Tools      </h4>
      <ul>
        <li><a href="allipAddresses.php">Check All Aviable devices on network.</a></li>
      </ul>
      <p>Please use the following program to prepare the Raspberry Pi SD Card </p>
      <ul>
        <li><a href="#">Win32DiskImager</a>(Recommended)</li>
        <li>To Download the latest version please go <a href="http://sourceforge.net/projects/win32diskimager/">here</a></li>
        <li><a href="#">Image File</a></li>
      </ul>
      <p>Online Video Encoder for MOV and WMV files</p>
      <ul>
        <li><a href="#">Online Video Converter</a></li>
      </ul>
