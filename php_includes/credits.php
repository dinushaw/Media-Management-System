...
<table width="960" align="center" cellpadding="0" cellspacing="0" class="tableboarder">
  ...
  <tr class="tableboarder">
    ...
    <td width="830" style="padding:10px;"><!-- InstanceBeginEditable name="EditRegion1" -->
      <p>&nbsp;</p>
      <h3>Credits </h3>
      <p>This Project was done as a part of  internship project by Dinusha Withanage of Swinburne University of Technology.&copy; 2014</p>
      <p>&nbsp; </p>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
  ...
  <tr class="footer">
    <td colspan="2" align="center" class="footerText"><p><span class="swinLogo"><a href="credits.php"><img src="../images/swinburneLogo.gif" width="68" height="33" class="swinLogo" /></a></span>  Telstra Museum  © 2014 v. 1.2
    </p>
      <p class="swinLogo">&nbsp;</p>
      <p class="swinLogo">&nbsp;</p>
    <p class="swinLogo">&nbsp;</p>
