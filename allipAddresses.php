...
<title>All Available devices on network</title>
<!-- InstanceEndEditable -->
...
<table width="960" align="center" cellpadding="0" cellspacing="0" class="tableboarder">
  ...
  <tr class="tableboarder">
    ...
    <td width="830" style="padding:10px;"><!-- InstanceBeginEditable name="EditRegion1" -->
       <?php 
	   exec("nmap 192.168.35.*",$result,$return_var);

echo "<h2> All Available Devices on Network </h2>";
echo '<ul>';
foreach ($result as $file_size) {
    echo  $file_size . '<br />';
}
echo '</ul>';
if ($return_var != 0) 
